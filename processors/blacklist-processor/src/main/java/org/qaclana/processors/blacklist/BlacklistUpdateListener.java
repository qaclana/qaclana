...
@Stateless
@Asynchronous
public class BlacklistUpdateListener {
    ...
    public void ipRangeBlacklisted(@Observes NewClientSocketMessage message) {
        ...
        IpRange ipRange = IpRange.fromJson(message.getMessage());
        blacklistContainer.add(ipRange);
    ...
    public void ipRangeRemovedFromBlacklist(@Observes NewClientSocketMessage message) {
        ...
        IpRange ipRange = IpRange.fromJson(message.getMessage());
        blacklistContainer.remove(ipRange);
        logger.removedIpRangeFromBlacklist(ipRange.toString());
    }
}
